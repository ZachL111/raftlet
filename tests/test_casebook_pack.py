"""Regression checks for the raftlet casebook."""
...
from casebook.harness import assert_expected, raftlet_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(raftlet_summary(), assert_expected())
