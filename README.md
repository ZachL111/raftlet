...
raftlet is a Java project for distributed systems. It focuses on this technical goal: Simulate Raft log replication, terms, and commit indexes.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 162, risk penalty 4, latency penalty 4, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
