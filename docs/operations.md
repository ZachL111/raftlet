...
`raftlet` is centered on distributed systems work in Java. The technical target is: Simulate Raft log replication, terms, and commit indexes.
...
The score is deterministic. The current threshold is 162. Risk has a penalty of 4, latency has a penalty of 4, and weight contributes a bonus of 4.
